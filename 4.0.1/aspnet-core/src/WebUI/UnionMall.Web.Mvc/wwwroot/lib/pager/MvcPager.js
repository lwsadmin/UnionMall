...
Webdiyer.MvcPager.prototype = {
    ...
    __ajax: function (index, options)
    {
        ...
        if (typeof Webdiyer.__ajaxPages[context.pageIndexName] === "undefined" || Webdiyer.__ajaxPages[context.pageIndexName] !== index || context.allowReload || 1 == 1)
        {
            ...
            if (index === -1 || index === 0)
            {
                ...
                //lws 修改 原来为 if (index === -1 || (index === 0 && context.isFirstLoading) || (index === context.currentPageIndex && !context.allowReload))
                return;
            }
