...
{
    [AbpMvcAuthorize("StatisticsAnalysis.WeChatIncomeStatistics")]
    [Area("Statistics")]
    public class WechatPayNoteController : UnionMallControllerBase
    {
        private readonly IWeChatPayNoteAppService _appService;
